...
class CreateRecipesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $recipe1 = new Recipes;
        $recipe1->productID = '1';
        $recipe1->ingredientID = '21';
        $recipe1->quantity = '1';
        $recipe1->save();

        $recipe2 = new Recipes;
        $recipe2->productID = '1';
        $recipe2->ingredientID = '24';
        $recipe2->quantity = '1';
        $recipe2->save();

        $recipe3 = new Recipes;
        $recipe3->productID = '2';
        $recipe3->ingredientID = '6';
        $recipe3->quantity = '1';
        $recipe3->save();

        $recipe4 = new Recipes;
        $recipe4->productID = '2';
        $recipe4->ingredientID = '24';
        $recipe4->quantity = '1';
        $recipe4->save();

        $recipe5 = new Recipes;
        $recipe5->productID = '3';
        $recipe5->ingredientID = '5';
        $recipe5->quantity = '1';
        $recipe5->save();

        $recipe6 = new Recipes;
        $recipe6->productID = '3';
        $recipe6->ingredientID = '24';
        $recipe6->quantity = '1';
        $recipe6->save();

        $recipe7 = new Recipes;
        $recipe7->productID = '4';
        $recipe7->ingredientID = '23';
        $recipe7->quantity = '1';
        $recipe7->save();
