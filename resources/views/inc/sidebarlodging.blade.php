...
<div class="container-fluid">
    <div class="row sidebarMainContent">
        <div class="container col-md-2" style="margin:0; padding:0;">
            <nav class="d-none d-md-block sidebar sidebar-lodging">
                ...
                <div class="text-center mb-4 px-3" style="background-color:#0808084a; color: white; position:fixed; bottom:0;">
                    <span id="week"></span>
